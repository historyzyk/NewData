...
/**
 * @function:角色表 sys_role
 * @Systemname:融媒体数据管理综合服务平台
 * @Author:刘波
 * @Description:
 * @Date:Created in 2020-01-20 18：13
...
public class SysRole extends BaseEntity
{
    ...
    @Excel(name = "数据范围", readConverterExp = "1=所有数据权限,2=自定义数据权限,3=本区域数据权限,4=本区域及以下数据权限")
